...
export default class Icx_fulfillmentActions extends LightningElement {
    ...
    handleClick(event) {
        var orderline, selectedLabel, selectedAction, ordershippingId, ordershipping;
        ...
        // debugger;    
        // String orderId, String requestingSystem, String sku, String actionMessage, String orderAction ,Id shippingId, Boolean insertTraceability

        // sendAction({
        //     body : bodyTosend,
        //     shippingId :ordershipping 
        // })
        console.log('icx_fulfillmentActions - sendAction params', ordershippingId, orderline.SKU, selectedLabel, selectedAction, ordershipping);

        sendAction({
            orderId: ordershippingId,
            // sku: orderline.SKU,
            actionMessage: selectedLabel,
            orderAction: selectedAction,
            shippingId: ordershipping,
        })
            .then(result => {
