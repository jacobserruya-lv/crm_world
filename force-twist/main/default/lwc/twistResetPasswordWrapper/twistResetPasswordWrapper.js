...
export default class TwistResetPasswordWrapper extends LightningElement {
    ...
    @track resetPasswordComponentQueryParams;
    @track oQueryParams;
    ...
    connectedCallback() {
        ...
        this.resetPasswordComponentQueryParams = JSON.stringify(mainChildComponentQueryParams);
        ...
        .then(result => {
            ...
            apexTranslateLabel({
                label: 'Twist_Header_Create_Password',
