...
export default class TwistAlternativeLoginWrapper extends LightningElement {
    ...
    @track alternativeLoginComponentQueryParams;
    @track oQueryParams;
    ...
    connectedCallback() {
        ...
        this.alternativeLoginComponentQueryParams = JSON.stringify(mainChildComponentQueryParams);
