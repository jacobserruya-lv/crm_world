({
    ...
    onResultClick : function(component, event, helper) {
        console.log('onResultClick '+ component.get('v.searchTerm'));
    ...
    onBlur : function(component, event, helper) {
        ...
        //allow user to insert email
        if(component.get('v.searchTerm')!=''){
            const selection = component.get('v.selection');
            selection.push({
                subtitle:component.get('v.searchTerm'),
                title: component.get('v.searchTerm'),
                id: component.get('v.searchTerm'),
                icon: "standard:email"
            });
