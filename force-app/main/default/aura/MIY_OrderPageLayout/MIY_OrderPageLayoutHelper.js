({
    doSplit: function (idsOption, options) {
        // adapted for Lightning from minified split.js
        var B = window,
            L = B.document,
            T = 'addEventListener',
            ...
            J = function (e, t, n) {
                var r = {};
                return isString(t) ? r[e] = t : r[e] = I ? t + '%' : calc + '(' + t + '% - ' + n + 'px)', r;
            },
            K = function (e, t) {
                var n;
                return (n = {})[e] = t + 'px', n;
            ...
            return (a = l.map(function (e, t) {
                var n, r, i, s = {element: elementOrSelector(e), size: m[t], minSize: h[t], i: t};
                if (0 < t && ((n = {
                    a: t - 1,
                    b: t,
                    dragging: !1,
