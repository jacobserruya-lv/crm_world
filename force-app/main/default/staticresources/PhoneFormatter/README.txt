/**
* To generate the phoneformatter.js based on:
* https://github.com/jackocnr/intl-tel-input
* https://github.com/googlei18n/libphonenumber
*
* Go to: https://closure-compiler.appspot.com/
* No URL, Optimization: Advanced, No Formatting
* Copy the code below and paste in the textarea
* Compile button
* If "Compilation was a success!", copy the Javascript file and used it in a Static Resource
* Lightning component:
*    <ltng:require styles="{!$Resource.PhoneFormatter + '/css/intlTelInput.css'}"
*                  scripts="{!join(',', 
*                           $Resource.PhoneFormatter + '/js/jquery.min.js', 
*                           $Resource.PhoneFormatter + '/js/intlTelInput.js',
*                           $Resource.PhoneFormatter + '/js/phoneformatter2.js'
*                           )}" 
*                  afterScriptsLoaded="{!c.afterScriptsLoaded}" />
*    <input id="phone" type="phone" onblur="{!c.handleClick}"/>
*
*    afterScriptsLoaded: function(component, event, helper) {
*        jQuery("#phone").intlTelInput({
*        });
*        var isValid = jQuery("#phone").intlTelInput("isValidNumber");
*    },
**/
